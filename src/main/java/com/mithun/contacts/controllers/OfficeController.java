package com.mithun.contacts.controllers;
...
import com.mithun.contacts.entities.Office;
import com.mithun.contacts.repositories.CompanyRepository;
import com.mithun.contacts.repositories.OfficeRepository;
...
public class OfficeController {
	...
	public String getAddOffice(@RequestParam("company_id") long companyId, Model model) {
		model.addAttribute("office", officeRepository.findOne(companyId));
		return "office/add";
	}
	...
	public String postOffice(@RequestParam long id) {
		Office office = officeRepository.findOne(id);
